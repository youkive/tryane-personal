...
import com.tryane.saas.connector.o365.utils.authentication.IO365AuthenticatorFactory;
import com.tryane.saas.connector.o365.utils.authentication.TryaneAzureAdApplication;
...
public class SPUserCustomActionRunner {
    ...
    @Autowired
    private IO365AuthenticatorFactory o365AuthenticatorFactory;
    ...
    public void executeRegisterOnSiteCollection(String siteCollectionUrl) {
        ...
        try {
            ...
            token = o365AuthenticatorFactory.getAuthenticator(TryaneAzureAdApplication.TA_SHAREPOINT).getAppAccessToken(siteCollection.getRootUrl(), tenantId).getAccessToken();
    ...
    public void deleteUserCustomActionOnSiteCollection(String siteCollectionUrl, String userCustomActionId) {
        ...
        String token = null;
        try {
            token = o365AuthenticatorFactory.getAuthenticator(TryaneAzureAdApplication.TA_SHAREPOINT).getAppAccessToken(ressourceSharepoint, tenantId).getAccessToken();
        } catch (O365UserAuthenticationException e1) {
            e1.printStackTrace();
        }
